...
class Model:
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        chktxt = '\n \n\n \n\n\n \t \t\t \t\n  \n   \n    \n     \nًںڑ€ (normal) ًںک¶\u200dًںŒ«ï¸ڈ (multiple emojis concatenated) âœ… ًں¦™ًں¦™ 3 33 333 3333 33333 333333 3333333 33333333 3.3 3..3 3...3 ل‍€ل‍¶ل‍“لں‹ل‍ڈلں‚ل‍–ل‍·ل‍ںلںپل‍ںل‍¢ل‍¶ل‍…ًںکپ ?وˆ‘وƒ³هœ¨appleه·¥ن½œ1314151ه¤©ï½‍ ------======= ذ½ذµر‰ذ¾ ذ½ذ° ذ‘رٹذ»ذ³ذ°ر€رپذ؛ذ¸ \'\'\'\'\'\'```````""""......!!!!!!?????? I\'ve been \'told he\'s there, \'RE you sure? \'M not sure I\'ll make it, \'D you like some tea? We\'Ve a\'lL'
    ...
    def set_vocab(self):
        ...
        for token_id in range(vocab_size):
            ...
            if text == b"\x00":
                ...
                logger.warning(f"InternLM2 convert token '{text}' to 'ًںگ‰'!")
                text = "ًںگ‰".encode("utf-8")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "--outtype", type=str, choices=["f32", "f16", "bf16", "q8_0", "q4_0", "auto"], default="f16",
